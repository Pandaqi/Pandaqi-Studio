...
export default class LShape extends Shape
{
    ...
    toPath()
    {
        ...
        const path = [
            ...
            topRight.clone().add(new Point(-this.extentsHole.x, this.extentsHole.y)),
    ...
    // @TODO: can I somehow make these functions the default on shape instead of repeating everywhere?
    toPath2D()
    {
