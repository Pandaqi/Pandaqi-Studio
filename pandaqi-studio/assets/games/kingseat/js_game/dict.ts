...
const PACK_DEFAULT = {
    ...
    bg: {
        ...
        icon: {
            scale: 1.425,
            offset: new Point().fromXY(0, -0.33),
            alpha: 0.125
        }
    },
    sigil: {
        scale: 1.35/2,
        offset: new Point().fromXY(0, -0.33) // offset is usually scaled by card size, and relative to card center
    },
    action: {
    ...
    corner: {
        offset: new Point().fromXY(0.1, 0.1),
        scale: 0.1
    },
    edges: {
        color: "#000000",
        colorDark: "#FFFFFF",
        lineWidth: 0.0066,
        lineScale: { x: 0.75, y: 0.85 }, // how much of the full size it should take up
