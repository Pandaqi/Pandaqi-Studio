export default class Evaluator
{
    ...
    calculateScoreForCell(state, cell, team)
    {
        ...
        const needsNoCalculation = this.cfg.typeDict[t].skipEval;
        ...
        if(t == "dragon" || t == "tortoise" || t == "bird" || t == "joker2") {
            ...
            score += 0.5*this.cfg.typeDict[t].score;
            ...
            if(isEven) { score += this.cfg.typeDict[t].score; }
            ...
            for(const nb of nbs)
            {
                ...
                score += this.cfg.typeDict[t].score;
            }
            ...
            if(allNeighborsEmpty) { score += this.cfg.typeDict[t].score; }
    ...
    draw(board)
    {
        ...
        const fontCfg = this.cfg.evaluator.font;
