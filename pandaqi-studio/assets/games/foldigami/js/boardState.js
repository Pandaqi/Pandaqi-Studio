...
export default class BoardState
{
    ...
    {
        const grid = [];
        const dims = this.cfg.board.dims;
        this.size = dims;
    ...
    {
        const newGrid = [];
        const dims = { x: grid.length, y: grid[0].length };
        this.size = dims;
        for(let x = 0; x < dims.x; x++)
        {
            newGrid[x] = [];
    ...
    getCellsInDirection(cell, params = {})
    {
