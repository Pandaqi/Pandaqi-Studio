...
export default class MapVisualizer {
    ...
    {
        if(!params) { return console.error("Can't visualize map without (valid) params."); }
        this.scaleDynamicParams(params);

        const obj = { rects: [], lines: [], circles: [], sprites: [], text: [] };
