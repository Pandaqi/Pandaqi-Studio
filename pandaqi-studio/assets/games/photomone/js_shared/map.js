...
export default class Map {
    constructor(params = {})
    {
        ...
        this.WORDS = params.WORDS || new WordsPhotomone(params);
    ...
    getNeighborsInRange(p1, rangeSquared)
    {
        const arr = [];
    ...
    calculateMinRangeBetweenPointsSquared(a,b)
    {
    ...
    isPointInsideMapPoints(p, exclude = [], params = {})
    {
    ...
    snapToClosestPoint(pos, repel = false)
    {
        const points = this.getPointsAsList();
    ...
    getBiggestDistanceToExisting(anchorPoint, linesToConsider)
    {
        const points = this.getPointsAsList();
        let biggestDist = 0;
