...
export const TUTORIAL_PARAMS = 
{
    maxTurns: 4,
    screens: {
        pick: "<p>Pick one of these words.</p><p><img src='/photomone-games/assets/icon_lines.webp' /> says how many lines you may draw.</p><p><img src='/photomone-games/assets/icon_points.webp' /> says how much food you score if the word is guessed.</p>",
