...
export default class InterfaceWordOptions {
    ...
    numWordsPerTurn: number;
    curSelectedOption: HTMLElement;
    ...
    constructor(interfaceObject:any, node: HTMLElement)
    {
    ...
    setWordEater(val: boolean) { this.wordEater = val; }
    ...
    deselectOption(node: HTMLElement)
    {
        if(!node) { return; }
    ...
    loadNewWords()
    {
        ...
        for(const wordObject of newWords)
        {
            ...
            counter++;
            cont.dataset.wordindex = counter.toString();
            ...
            linesSprite.src = "/photomone-games/assets/icon_lines.webp";
            ...
            pointsSprite.src = "/photomone-games/assets/icon_points.webp";
