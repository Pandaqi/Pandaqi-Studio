import CONFIG from "games/slippery-slopes/js_shared/config";
...
export default class InstructionScreen
{
    ...
    // @TODO: switch to signals, so we never even need to know about the game
    constructor()
    {
        this.setupHTML();
        this.hide();
    ...
    showWelcome()
    {
        ...
        p.innerHTML = "On your turn, tap the button to get <strong>" + CONFIG.wordCards.numPerCard + " new words</strong>. Pick one in <strong>secret</strong>.";
