import { INGREDIENTS, SPECIAL_CELLS } from "../js/gameDictionary"
...
export default class Cell {
	...
	setGarden(g) { this.garden = g; }
	hasGarden() { return this.garden != null; }

	setType(tp) { this.type = tp; }
	getType() { return this.type; }
	getTypeAsFrame() { 
		return SPECIAL_CELLS[this.getType()].frame;
	}

	setIngredient(i) { this.ingredient = i; this.ingredientName = Object.keys(INGREDIENTS)[i]; }
