import { SPECIAL_CELLS } from "../js/gameDictionary"
...
class BoardGeneration extends Scene
{
	...
	paintGarden(graphics, garden, idx)
	{
	...
	findGardenBorders(garden, borders)
	{
	...
	visualizeGardenBorders(graphics)
	{
	...
	visualizeSpecialCells(_graphics)
	{
