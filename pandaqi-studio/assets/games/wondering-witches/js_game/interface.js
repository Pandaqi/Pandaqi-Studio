import { EFFECT_DICT } from "../js/gameDictionary"
...
export default class Interface {
	...
	createAddIngredientButton(index, ing)
	{
	...
	createEffectUIHints()
	{
		...
		for(const effectName of effectsUnique)
		{
			...
			span.addEventListener('click', (ev) => {
				...
				effExplNode.innerHTML = this.effectExplanations[effectName];
				this.activeEffectExplanation = effectName;
			});

			this.effectExplanations[effectName] = EFFECT_DICT[effectName].explanation;
		}
	}

	onPotionResult(params)
	{
	...
	drawWeighted(list, remove = false)
	{
