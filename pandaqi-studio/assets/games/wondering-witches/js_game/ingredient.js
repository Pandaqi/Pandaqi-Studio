import { INGREDIENTS, DECOY_NAMES, EFFECT_DICT } from "../js/gameDictionary"

// holds one ingredient
export default class Ingredient {
	constructor(config, index, num = 1, effects = [], decoy = -1, seeds = 0) {
		this.config = config;
		this.setNum(num);
    ...
    setSeeds(s) { this.seeds = s; }
    getSeeds() { return this.seeds; }

	isDecoy() { return this.decoy >= 0; }
	isDecoyType(tp) { return this.decoy == tp; }
	...
	addEffect(tp) { this.effects.push(tp); }
