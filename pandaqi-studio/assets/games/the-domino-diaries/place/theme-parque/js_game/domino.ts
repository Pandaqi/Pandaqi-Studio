...
import { CHALLENGES, ChallengeType, DYNAMIC_REPLACEMENTS, DominoType, EVENTS, EventVibe, MISC } from "../js_shared/dict";
...
export default class Domino
{
    ...
    drawEvent(vis:MaterialVisualizer, group:ResourceGroup)
    {
        ...
        const positions = [scoreOffset.clone(), new Point(vis.size.x-scoreOffset.x, scoreOffset.y)];
