...
import { ATTRACTIONS, CHALLENGES, COASTER_PARTS, DECORATIONS, DominoType, EVENTS, ITEMS, ItemType, PATHS, PathType, STALLS } from "../js_shared/dict";
