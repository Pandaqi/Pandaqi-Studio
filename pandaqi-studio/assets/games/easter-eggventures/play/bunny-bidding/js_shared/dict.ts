...
const SPECIAL_EGGS:TileDataDict =
{
    ...
    bonus_tiles: { frame: 10, desc: "Play (at least) 3 tiles this turn.", freq: 1 },
    ...
    matching_money: { frame: 16, desc: "<b>Bids</b> whose type is also <b>in the offer</b> get +50 or -50 (your choice).", freq: 1 },
    reverse_auction: { frame: 17, desc: "Invert the auction. (Overrides any other inversions.)", freq: 2 },
...
const POWERS:TileDataDict = 
{
    ...
    large_hands: { frame: 6, label: "Large Hands", desc: "You may play at least 3 tiles every turn." },
...
const HANDICAPS:TileDataDict =
{
    ...
    bid_lower: { frame: 10, label: "Bid Lower", desc: "You must always bid lower than the highest offer tile." },
    bid_higher: { frame: 11, label: "Bid Higher", desc: "You must always bid higher than the lowest offer tile." },
    always_faceup: { frame: 12, label: "Always Faceup", desc: "You must always play at least 2 faceup tiles." },
    small_hands: { frame: 13, label: "Small Hands", desc: "You may only play at most 3 tiles on your turn." },
    lower_bids: { frame: 14, label: "Lower Bids", desc: "You permanently get -10 to your bid tile." },
