...
const ROOMS:TileDataDict =
{
    ...
    library_2: { frame: 30, areas: [{ pos: new Point(209, 845) }, { pos: new Point(753, 289) }] },
    library_3: { frame: 31, areas: [{ pos: new Point(489, 729) }], set: "cluesRooms" },

    basement_2: { frame: 32, areas: [{ pos: new Point(317, 784) }] },
    basement_3: { frame: 33, areas: [{ pos: new Point(429, 560) }, { pos: new Point(796, 237) }], set: "cluesRooms" },
    attic_2: { frame: 34, areas: [{ pos: new Point(510, 804) }] },
    attic_3: { frame: 35, areas: [{ pos: new Point(680, 138) }, { pos: new Point(749, 802) }], set: "cluesRooms" },
    foyer_2: { frame: 36, areas: [{ pos: new Point(441, 644) }] },
    kitchen_2: { frame: 37, areas: [{ pos: new Point(270, 265) }, { pos: new Point(704, 830) }] },
    kitchen_3: { frame: 38, areas: [{ pos: new Point(774, 758) }], set: "cluesRooms" },
    laundry_room_2: { frame: 39, areas: [{ pos: new Point(498, 464) }] },

    laundry_room_3: { frame: 40, areas: [{ pos: new Point(516, 748) }], set: "cluesRooms" },
    storage_2: { frame: 41, areas: [{ pos: new Point(385, 560) }, { pos: new Point(697, 798) }], set: "cluesRooms" },
    storage_3: { frame: 42, areas: [{ pos: new Point(388, 817) }], set: "cluesRooms" },
    garden_2: { frame: 43, areas: [{ pos: new Point(176, 282) }, { pos: new Point(537, 814) }] },
    garden_3: { frame: 44, areas: [{ pos: new Point(546, 470) }], set: "cluesRooms" },
