import { PLANET_MAP, PLANET_SETS, NUMBERS, EVENTS, RESOURCES, EFFECTS, BUILDINGS, PEOPLE, COMPONENTS } from "../js/gameDictionary"
...
export default {
    ...
    determineRandomComponentSet(cfg) 
    {
        ...
        for(let i = planetSet.length; i < cfg.maxPlanetSetSize; i++) {
