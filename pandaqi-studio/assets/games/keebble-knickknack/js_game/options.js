...
export default class Options {
    ...
    createFullLetterDictionary()
	{
        ...
        const letters = this.game.getConfig().scrabbleScores;
    ...
    createFullCellDictionary()
    {
        ...
        const types = this.game.getConfig().cellTypes;
        ...
        if(!forPowerup)
        {
            ...
            for(const [letter, letterData] of Object.entries(this.letterDictionary))
            {
                ...
                if(enhancedLetters.includes(letter)) { 
                    probFinal = this.game.getConfig().enhancedLetterProbForPowerup; 
                }
