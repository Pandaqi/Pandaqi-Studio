...
export default class Interface {
    ...
    createHTML()
    {
        ...
        this.turnsIcon.src = "/photomone/assets/icon_turns.webp";
        ...
        this.foodIcon.src = "/photomone/assets/icon_points.webp";
        ...
        // interactive canvas
        this.canvasDrawable = new PHOTOMONE.CanvasDrawable(contentNode, this.game.getConfig());
        ...
        this.wordOptions = new PHOTOMONE.InterfaceWordOptions(this, contentNode);
        ...
        leaveBtn.addEventListener("click", (ev) => {
            window.location.href = "https://pandaqi.com/photomone-digital-antists"
        });
    ...
    toggleNode(node, val, string = "block")
    {
        if(val) { node.style.display = string; }
        else { node.style.display = "none"; }
    }

    toggleBar(val) { this.toggleNode(this.barNode, val); }
    toggleWindow(val) { this.toggleNode(this.windowNode, val); }
    toggleCanvas(val) 
    { 
