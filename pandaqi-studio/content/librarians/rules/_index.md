...
{{< rules/rules-image src="gameplay_play.webp" alt="Example of a turn: play 2 cards in alphabetical order." >}}
...
{{< rules/rules-image src="gameplay_genrematch.webp" alt="Example of how to match or complete a genre, with a 4 in a row." >}}
...
<!--- @DISCARDED: Books that have multiple colors are **wildcards**. They can represent any genre when matching, but have no action. --->
...
{{< rules/rules-image src="expansion_shelves.webp" alt="Example of the three newly added rules and how they work." >}}
