...
class GameState
{
    ...
    getIndexOf(player) { return this.players.indexOf(player); }
    getRandomPlayer(exclude = [])
    {
        const arr = [];
    ...
    getNextUnhandledPlayer(startingIndex = this.kingseat)
    {
...
async function generate()
{
    ...
    while(board.getUnhandledPlayers().length > 0)
    {
        ...
        const p = board.getNextUnhandledPlayer(idx + 1);
...
const princeInfos = document.getElementsByClassName("prince-info")
