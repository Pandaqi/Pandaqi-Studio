...
import { SettingType, TextConfig, TextStyle, Vector2, MapperPreset, CVal } from "lib/pq-games"
import { dominoPicker } from "../game/dominoPicker"
import { TerrainType, DinoType } from "./dict"
...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/the-domino-diaries/place/dinoland/assets/",
        files:
        {
            tinos:
            {
    ...
    _drawing:
    {
        ...
        dominoes:
        {
            ...
            dino:
            {
                ...
                sizeArrow: new CVal(new Vector2(0.66), "sizeUnit"),
                shadowColor: "#111111",
