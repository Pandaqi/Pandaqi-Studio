...
export const MISSION_SCALARS:Record<string, GeneralData> =
{
    ...
    players_connected: { frame: 6, desc: "# players connected", value: 0.33, sets: ["machine"] }, // @IMPROV: explain it's about players connected on the shared map? Add extra little "explanations" to these things anyway?
