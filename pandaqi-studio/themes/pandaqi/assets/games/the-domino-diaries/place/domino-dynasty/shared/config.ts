...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/the-domino-diaries/place/domino-dynasty/assets/",
        files:
        {
            caslon:
            {
    ...
    {    
        ...
        dominoes:
        {
            ...
            main:
            {
                ...
                sizeCapital: new CVal(new Vector2(0.975), "sizeUnit")
            },

            mission:
            {
                fontSize: new CVal(0.062, "sizeUnit"),
                posFlavorText: new CVal(new Vector2(0.075, 0.175), "size"),
                sizeFlavorText: new CVal(new Vector2(0.835, 0.5), "size"),

                requirements:
                {
                    pos: new CVal(new Vector2(0.5, 0.48), "size"),
                    size: new CVal(new Vector2(0.195), "sizeUnit"), // this is PER icon/requirement

                    posIcon: new CVal(new Vector2(-0.38, 0), "size"), // this is RELATIVE to (0,0) in center of requirement row
                    posText: new CVal(new Vector2(0.45, 0), "size"),
                    fontSize: new CVal(0.07, "sizeUnit")
                },

                consequence:
                {
                    posHeader: new CVal(new Vector2(0.5, 0.8), "size"),
                    posText: new CVal(new Vector2(0.5, 0.885), "size"),
                    sizeText: new CVal(new Vector2(0.835, 0.185), "size"),
                    sizeHeader: new CVal(new Vector2(0.35), "sizeUnit"),
                },

                shushIcon:
                {
                    pos: new CVal(new Vector2(0.9, 0.14), "size"),
                    size: new CVal(new Vector2(0.175), "sizeUnit")
                }
            },
            ...
            events:
            {
                ...
                posHeader: new CVal(new Vector2(0.5, 0.33), "size"),
                fontSizeBody: new CVal(0.075, "sizeUnit"),
                posBody: new CVal(new Vector2(0.5, 0.6), "size")
            },
