...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/the-domino-diaries/place/zoo-parque/assets/",
        files:
        {
            noticia:
            {
    ...
    _material:
    {
        ...
        tiles:
        {
            ...
            mapper:
            {
                ...
                size: { 
                    small: new Vector2(2,5),
                    regular: new Vector2(1,4),
    ...
    _drawing:
    {
        ...
        dominoes:
        {
            drawerConfig:
            {
                preset: MapperPreset.DOMINO
            },

            bg:
            {
                color: "#FFEFCF",
                sizeTerrain: new CVal(new Vector2(0.9), "sizeUnit"),
                terrainShadowSize: new CVal(0.01, "sizeUnit"),
            },

            main:
            {
                size: new CVal(new Vector2(0.66), "sizeUnit"),
                shadowSize: new CVal(0.02, "sizeUnit"),
            },

            fences:
            {
                size: new CVal(new Vector2(0.88), "sizeUnit")
            },
            ...
            campaign:
            {
                textBoxSize: new CVal(new Vector2(0.9, 0.4), "size"),
                fontSize: new CVal(0.07, "sizeUnit"),
                posMission: new CVal(new Vector2(0.5, 0.5), "size"),
                posRule: new CVal(new Vector2(0.5, 0.86), "size"),

                score:
                {
                    pos: new CVal(new Vector2(0.48, 0.09), "size"),
                    fontSize: new CVal(0.3, "sizeUnit"),
                },

                expansions:
                {
                    pos: new CVal(new Vector2(0.8, 0.0915), "size"),
        ...
        tiles:
        {
            animal:
            {
                pos: new CVal(new Vector2(0.22, 0.5), "size"),
                size: new CVal(new Vector2(0.435), "sizeUnit")
            },

            extinct:
            {
                pos: new CVal(new Vector2(0.275, 0.325), "size"),
                size: new CVal(new Vector2(0.2), "sizeUnit")
            },

            funFact:
            {
                pos: new CVal(new Vector2(0.225, 0.815), "size"),
                size: new CVal(new Vector2(0.225, 0.45), "size"),
                fontSize: new CVal(0.033, "sizeUnit")
            },

            terrains:
            {
                posAnchor: new CVal(new Vector2(0.615, 0.38), "size"),
                size: new CVal(new Vector2(0.1225), "sizeUnit"),
                shadowBlur: new CVal(0.005, "sizeUnit")
            },

            food:
            {
                pos: new CVal(new Vector2(0.815, 0.2875), "size"),
                size: new CVal(new Vector2(0.4, 0.2), "sizeUnit"),
                fontSize: new CVal(0.0475, "sizeUnit")
            },

            power:
            {
                pos: new CVal(new Vector2(0.51, 0.735), "size"),
                size: new CVal(new Vector2(0.285, 0.3), "size"),
                fontSize: new CVal(0.033, "sizeUnit")
            },
            ...
            checkmarks:
            {
                size: new CVal(new Vector2(0.075), "sizeUnit"),
                strong: new CVal(new Vector2(0.4415, 0.2875 - 0.025), "size"),
                herbivore: new CVal(new Vector2(0.4415, 0.51), "size"),
                carnivore: new CVal(new Vector2(0.65, 0.51), "size"),
                social: new CVal(new Vector2(0.4415, 0.615), "size"),
                solitary: new CVal(new Vector2(0.65, 0.615), "size"),
            }
        },
