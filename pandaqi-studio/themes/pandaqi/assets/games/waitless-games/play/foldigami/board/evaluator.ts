...
import { MaterialVisualizer, ResourceGroup, TextConfig, TextAlign, ResourceText, LayoutOperation, Vector2, StrokeAlign } from "lib/pq-games";
...
export default class Evaluator
{
    ...
    {
        const fontCfg = vis.get("evaluator.font");
        ...
        const opText = new LayoutOperation({
            pos: new Vector2(textX, textY),
            fill: fontCfg.color,
            size: new Vector2(10*textConfig.size),
