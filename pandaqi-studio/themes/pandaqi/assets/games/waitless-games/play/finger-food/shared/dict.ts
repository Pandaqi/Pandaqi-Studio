...
export const MACHINES = 
{
    ...
    refrigerator: { frame: 18, colorGroup: "blue", power: 1, requiredExpansions: ["money"], max: 3, forbiddenMachines: ["freezer"], prob: 1.5, timerRelevant: true }, // @IMPROV: check if placed next to money on adjacent squares in evaluator
    freezer: { frame: 19, colorGroup: "pink", power: 2, requiredExpansions: ["money"], max: 1, forbiddenMachines: ["refrigerator"], prob: 1.5, timerRelevant: true }, // @IMPROV: needs money in same row/column checked in evaluator
