...
import { shuffle, MaterialVisualizer, ResourceGroup, LayoutOperation, DropShadowEffect, Vector2, TintEffect, TextConfig, ResourceText, GlowEffect } from "lib/pq-games";
import { COLORS, CardDisplayType, CardType, ColorType, DYNAMIC_STRINGS, FINISH_REQUIREMENTS, MISC, POSITIONS, RULE_CARDS, ShapeType } from "../shared/dict";
...
export default class Card
{
    ...
    drawRuleCard(vis:MaterialVisualizer, group:ResourceGroup)
    {
        ...
        const opTextID = new LayoutOperation({
            ...
            size: new Vector2(2.0 * textConfigID.size),
            fill: "#666666",
            pivot: Vector2.CENTER
        });
