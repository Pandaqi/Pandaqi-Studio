import { getMaterialDataForRulebook, shuffle, rangeInteger, SettingType } from "lib/pq-games";
import { InteractiveExampleSimulator, loadRulebook, SettingType as SettingTypeRulebook } from "lib/pq-rulebook";
...
const generate = async (sim:InteractiveExampleSimulator) =>
{
    ...
    // > cards on the table
    const allCards : Card[] = shuffle(cardPicker());
