...
import { shuffle, MaterialVisualizer, convertCanvasToImageMultiple, getMaterialDataForRulebook, rangeInteger } from "lib/pq-games";
    ...
    tables:
    {
        "powers-limited":
        {
            icons:
            {
                config:
                {
                    sheetURL: CONFIG._resources.files.powers.path,
                    sheetWidth: 8,
