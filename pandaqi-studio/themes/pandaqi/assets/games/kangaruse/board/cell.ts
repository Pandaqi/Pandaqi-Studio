...
import { NB_OFFSETS, CELLS } from "../shared/dict";
...
export default class Cell
{
    ...
    getPositionCenter() { return new Vector2(this.x+0.5, this.y+0.5); }
    getPositionTopLeft() { return new Vector2(this.x, this.y); }
    getPositionBottomRight() { return new Vector2(this.x + 1, this.y + 1); }
