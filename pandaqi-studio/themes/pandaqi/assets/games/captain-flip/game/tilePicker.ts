...
export const tilePicker = () =>
{
    ...
    const numTiles = CONFIG._drawing.tiles.generation.numDeckTotal;
    const numDouble = CONFIG._drawing.tiles.generation.percentageDoubleTiles * numTiles;
    const numSingle = CONFIG._drawing.tiles.generation.percentageSingleTiles * numTiles;
    ...
    for(let i = 0; i < numTiles; i++)
    {
        ...
        if(i < numDouble) {
            ...
            const secondAction = findUniqueAction(firstAction, actions);
...
const findUniqueAction = (givenAction:TileActionData, actions:TileActionData[]) =>
{
