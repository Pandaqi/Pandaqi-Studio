...
import { SettingType, TextConfig, TextWeight, TextStyle, Vector2, MapperPreset, CVal, Bounds } from "lib/pq-games"
    ...
    _drawing:
    {
        ...
        cards:
        {
            ...
            title:
            {
                ...
                offsetY: 0.485,
                size: new CVal(new Vector2(0.7, 0.2), "size"),
            ...
            background:
            {
                size: new CVal(new Vector2(0.95), "size"),
                sizeOverlayRelative: new Vector2(0.88, 0.8675), // "usable" size of book relative to calculated size
            ...
            genre:
            {
                ...
                cornerOffset: new CVal(new Vector2(0.057), "sizeUnit"),
                sizeIcon: new CVal(new Vector2(0.078), "sizeUnit"),
                sizeRect: new CVal(new Vector2(0.33), "sizeUnit"),
                textColor: "#000000",
                textComposite: "overlay",
                fontSize: new CVal(0.075, "sizeUnit"),
                textOffsetY: new CVal(new Vector2(0.05), "sizeUnit")
            },
            ...
            bookShelf:
            {
                arrow:
                {
                    ...
                    sizeVertical: new CVal(new Vector2(0.175), "sizeUnit"),
                    sizeRect: new CVal(new Vector2(0.65, 0.3), "size"),
                },

                text:
                {
                    pos: new CVal(new Vector2(0.5, 0.66), "size"),
                    size: new CVal(new Vector2(0.75, 0.35), "size"),
                    color: "#000000",
                    fontSize: new CVal(0.075, "sizeUnit")
                }
            },
            ...
            metadata:
            {
                ...
                sizeIcon: new CVal(new Vector2(0.065), "sizeUnit"),
            ...
            action:
            {
                ...
                sizeIcon: new CVal(new Vector2(0.15), "sizeUnit"),
            }
