...
export const HEALTH_CARDS:Record<string,MaterialNaivigationData> = 
{
    ...
    cross_decisions: { shared: true, label: "Cross Decisions", desc: "If playing with 2 teams, the first card that requires a <b>decision</b> (when executed) is handled by the <b>other team</b>.", num: 1 }
};
...
interface TemplateData
{
    ...
    smallIconOffset?: Vector2, // placement of smaller versions of icons is one major difference between templates
    extraNumberOffset?: Vector2, // where to position the (optional) number on a select few templates
    titleTextPos?: Vector2, // where to position the title text, for customization on some templates
    iconScale?: Vector2, // how to scale the main icon (relative to the usual (1,1) scale)
    iconOffset?: Vector2, // offset for the MAIN icon
}

export const TEMPLATES:Record<string, TemplateData> =
{
    [CardType.VEHICLE]: { frameTemplate: 0, bgColor: "#FFFFFF", tintColor: "#DADADA", label: null, subText: "Vehicle Card", smallIconOffset: new Vector2(0.33, 0), textureKey: "vehicle_cards" },
    [CardType.HEALTH]: { frameTemplate: 2, frameIcon: 5, bgColor: "#F9C98C", label: null, subText: "Health", smallIconOffset: new Vector2(0.35, -0.05), extraNumberOffset: new Vector2(0.46, 0), textureKey: "misc_shared" },
    [CardType.GPS]: { frameTemplate: 3, frameIcon: 6, bgColor: "#A6741A", label: "GPS", subText: null, titleTextPos: new Vector2(0.5, 0.605), textureKey: "misc_shared" },
    [CardType.TIME]: { frameTemplate: 4, frameIcon: 7, bgColor: "#4AD9FC", label: "Time", subText: "Event", extraNumberOffset: new Vector2(0.46, -0.2), textureKey: "misc_shared" },
    ...
    [CardType.ACTION]: { frameTemplate: 1, bgColor: "#FFFFFF", tintColor: "#DADADA", label: null, subText: "Action Card", smallIconOffset: new Vector2(0.4125, 0), textureKey: "icons" },
    [CardType.INSTRUCTION]: { frameIcon: 1, textureKey: "icons" },
    [CardType.COMPASS]: { frameIcon: 0, textureKey: "icons" },
    [CardType.PASSENGER]: { frameTemplate: 6, bgColor: "#f5b7ff", label: null, subText: "Cargo", titleTextPos: new Vector2(0.5, 0.39), iconScale: new Vector2(0.63), iconOffset: new Vector2(0, -0.125), textureKey: "persons" },
