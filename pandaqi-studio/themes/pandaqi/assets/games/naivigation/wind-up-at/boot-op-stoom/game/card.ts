import { MaterialVisualizer, ResourceGroup, LayoutOperation, DropShadowEffect, getPositionsCenteredAround, Vector2, fromArray, TextConfig, TextStyle, ResourceText } from "lib/pq-games";
import { CardType, CARD_TEMPLATES, MAP_TILES, PAKJE_CARDS, VAAR_CARDS, STOOM_CARDS, KALENDER_KAARTEN } from "../shared/dict";
...
export default class Card
{
    ...
    // @IMPROV: Maybe find better solution than FLIPPING these cards on Y-axis. Because now text ("Stoombootkaart") will be flipped too.
    drawStoomKaart(vis:MaterialVisualizer, group:ResourceGroup)
    {
        ...
        if(this.isFlipped)
        {
            pos = new Vector2(pos.x, vis.size.y - pos.y);
        }
