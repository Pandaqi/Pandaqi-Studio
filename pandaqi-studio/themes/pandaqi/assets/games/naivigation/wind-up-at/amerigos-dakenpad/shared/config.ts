...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/naivigation/wind-up-at/amerigos-dakenpad/assets/",
        files:
        {
            crimson:
            {
    ...
    _drawing:
    {
        ...
        cards:
        {
            route:
            {
                homePos: new CVal(new Vector2(0.5, 0.66), "size"),
                homeSize: new CVal(new Vector2(0.75), "sizeUnit"),
                giftPos: new CVal(new Vector2(0.5, 0.15), "size"),
                giftSize: new CVal(new Vector2(0.2), "sizeUnit"),

                text:
                {
                    fontSize: new CVal(0.07, "sizeUnit"),
                    boxSize: new CVal(new Vector2(0.85, 0.25), "size")
                }
            },
            ...
            varen:
            {
                ...
                size: new CVal(new Vector2(0.75), "sizeUnit"),
                text:
                {
                    pos: new CVal(new Vector2(0.5, 0.7225), "size"),
                    size: new CVal(new Vector2(0.85, 0.3), "size"),
                    fontSize: new CVal(0.1, "sizeUnit")
                },

                icons:
                {
                    anchor: new CVal(new Vector2(0.15, 0.915), "size"),
            ...
            pakje:
            {
                pos: new CVal(new Vector2(0.5, 0.475), "size"),
                size: new CVal(new Vector2(0.775), "sizeUnit")
            },

            numbers:
            {
                offset: new CVal(new Vector2(0.134, 0.1215), "sizeUnit"),
                fontSize: new CVal(0.12, "sizeUnit"),

                dots:
                {
                    interval: 5,
                    offset: new CVal(new Vector2(0, 0.1), "sizeUnit"),
                    size: new CVal(new Vector2(0.0325), "sizeUnit"),
                    sizePadded: new CVal(new Vector2(0.036), "sizeUnit"),
                }
            },
        },
    }
