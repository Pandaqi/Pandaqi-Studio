...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/naivigation/visit/singing-sails/assets/",
        files:
        {
            misc:
            {
    ...
    _drawing:
    {
        ...
        tiles:
        {
            enemyIcon:
            {
                pos: new CVal(new Vector2(0.1), "sizeUnit"),
            ...
            treasure:
            {
                ...
                textBoxDims: new CVal(new Vector2(0.7, 0.33), "size"),
                conditionPos: new CVal(new Vector2(0.5, 0.41), "size"),
                bonusPos: new CVal(new Vector2(0.5, 0.72), "size"),
                iconOffset: new CVal(new Vector2(0.125, 0.135), "size"),
                harborIconSize: new CVal(new Vector2(0.1), "sizeUnit")
            },
