...
export const WEATHER_CARDS:Record<string,MaterialNaivigationData> =
{
    ...
    sunny_day: { frame: 5, label: "Sunny Day", num: 2, desc: "You're <b>not required</b> to play a Weather card if you have one." }, // @IMPROV: most unsure about this one, as it can lock the entire weather mechanic easily
