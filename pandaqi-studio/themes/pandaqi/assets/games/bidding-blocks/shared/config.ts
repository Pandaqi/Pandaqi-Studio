import { Bounds, CVal, SettingType, Vector2 } from "lib/pq-games"
    ...
    {     
        ...
        cards:
        {
            main:
            {
                ...
                size: new CVal(new Vector2(0.92), "sizeUnit"),
            },

            fitsOnTop:
            {
                pos: new CVal(new Vector2(0.5, 0.115), "size"),
                size: new CVal(new Vector2(0.235), "sizeUnit")
            },

            numbers:
            {
                fontSize: new CVal(0.175, "sizeUnit"),
                offset: new CVal(new Vector2(0.1, 0.135), "sizeUnit"),
                doubleDigitsScaleDown: 0.775,
            },

            suitIcons:
            {
                offset: new CVal(new Vector2(0.27, 0.17), "sizeUnit"), // should fit perfectly in this background circles
                size: new CVal(new Vector2(0.0775), "sizeUnit")
            }
        },
    }
}