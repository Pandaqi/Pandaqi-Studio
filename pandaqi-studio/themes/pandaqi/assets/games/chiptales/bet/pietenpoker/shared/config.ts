...
import { SettingType, TextConfig, TextWeight, Vector2, Bounds, CVal, MapperPreset } from "lib/pq-games";
...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/chiptales/bet/pietenpoker/assets/",
        files:
        {
            kiwimaru:
            {
    ...
    _drawing:
    {
        ...
        cards:
        {
            corners:
            {
                numberOffset: new CVal(new Vector2(0.125, 0.125), "sizeUnit"),
                iconSize: new CVal(new Vector2(0.15), "sizeUnit"),
            ...
            text:
            {
                ...
                colorLabel:
                {
                    offset: new CVal(new Vector2(0.2, 0.108), "size"),
                    fontSize: new CVal(0.065, "sizeUnit")
                },

                sintLabel:
                {
                    offset: new CVal(new Vector2(0.5, 0.09), "size")
                }
            },

            icons:
            {
                sintSize: new CVal(new Vector2(0.8), "sizeUnit"),

                rowDisplay:
                {
                    offset: new CVal(new Vector2(0.18, 0.04), "size"),
                    size: new CVal(new Vector2(0.08), "sizeUnit")
                },

                templateScaleFactor: new CVal(new Vector2(0.28, 0.33), "size"),  
                size: new CVal(new Vector2(0.22), "sizeUnit"),

                special:
                {
                    randomVariation: new CVal(new Vector2(0, 0.35), "size"),
                    surprise: new CVal(new Vector2(0.08, 0.5), "size"),
                    bid: new CVal(new Vector2(0.92, 0.5), "size"),
            ...
            action:
            {
                ...
                illu:
                {
                    pos: new CVal(new Vector2(0.5, 0.313), "size"),
                    rot: -0.2007,
                    size: new CVal(new Vector2(0.425), "sizeUnit")
                },

                desc:
                {
                    pos: new CVal(new Vector2(0.525, 0.71), "size"),
                    rot: -0.22689,
                    fontSize: new CVal(0.07, "sizeUnit"),
                    textBoxSize: new CVal(new Vector2(0.7, 0.33), "size")
                }
            }
        },
    }
