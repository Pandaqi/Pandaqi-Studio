...
export const ICON_POSITIONS:Vector2[] = [
    new Vector2(-1, -0.7), new Vector2(0, -0.85), new Vector2(1, -1), // top row
    new Vector2(-1, 0.15), new Vector2(0, 0), new Vector2(1, -0.15), // middle row
    new Vector2(-1, 1.0), new Vector2(0, 0.85), new Vector2(1, 0.7), // bottom row
]