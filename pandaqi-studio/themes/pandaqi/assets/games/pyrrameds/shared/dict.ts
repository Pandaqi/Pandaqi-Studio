...
const SPECIAL_ACTIONS:Record<string,GeneralData> =
{
    ...
    patient_reward_extra: { desc: "On patient reward, cards other players show you must <b>match type</b> with the specific requirements (if possible).", type: SpecialActionType.ALWAYS } // @IMPROV: This one might be too difficult if I want to keep text short ...
}
