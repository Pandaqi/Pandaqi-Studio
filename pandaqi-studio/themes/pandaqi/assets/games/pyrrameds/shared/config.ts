...
export const CONFIG = 
{
    ...
    rulebook:
    {
        ...
        boardCanvasSize: new Vector2(720, 720),
        itemSize: new Vector2(750, 1050),
        itemSizeDisplayed: new Vector2(375, 525),
    ...
    _drawing:
    {
        ...
        cards:
        {
            shared:
            {
                ...
                shadowOffset: new CVal(new Vector2(0, 0.0275), "sizeUnit"),
            },
            ...
            number:
            {
                ...
                pos: new CVal(new Vector2(0.5, 0.37), "size"),
            },

            medicine:
            {
                pos: new CVal(new Vector2(0.5, 0.715), "size"),
                iconDims: new CVal(new Vector2(0.4), "sizeUnit"),
            },

            patient:
            {
                iconDims: new CVal(new Vector2(0.25), "sizeUnit"),
                posAnchor: new CVal(new Vector2(0.5, 0.75), "size"), // should be close to medicine.pos, but lower
                illustration:
                {
                    pos: new CVal(new Vector2(0.17, 0.37), "size"), // should match number.pos on Y-axis
                    sizeCircle: new CVal(new Vector2(0.275), "sizeUnit"),
                    sizeIcon: new CVal(new Vector2(0.21), "sizeUnit")
                }
            },
            ...
            special:
            {
                ...
                textBoxPos: new CVal(new Vector2(0.5, 0.73), "size"),
                textBoxDims: new CVal(new Vector2(0.75, 0.66), "size"),
                textColor: "#000000"
            }
        },
    }
