...
import { fromArray, MaterialVisualizer, DropShadowEffect, createContext, fillCanvas, ResourceGroup, LayoutOperation, Vector2, TextConfig, ResourceText, StrokeAlign } from "lib/pq-games";
...
export default class Card
{
    ...
    drawNumbers(vis:MaterialVisualizer, group:ResourceGroup)
    {
        ...
        const opHealthBox = new LayoutOperation({
            pos: new Vector2(vis.size.x - offset.x, offset.y),
            size: size,
            pivot: Vector2.CENTER,
        ...
        const opTextHealth = new LayoutOperation({
            pos: opHealthBox.pos.clone().add(new Vector2(textInBoxOffset.x, -textInBoxOffset.y)),
            size: size,
            pivot: Vector2.CENTER,
            fill: "#FFFFFF",
            stroke: "#222222",
        ...
        const opText = new LayoutOperation({
            ...
            size: new Vector2(1.5 * textConfigMain.size),
            pivot: Vector2.CENTER,
            fill: "#000000",
            stroke: "#FFFFFF",
        ...
        if(vis.get("cards.mainNumber.addWrittenVersion"))
        {
            ...
            const opTextWritten = new LayoutOperation({
                ...
                size: new Vector2(vis.size.x, 1.5 * textConfigWritten.size),
                pivot: Vector2.CENTER,
                fill: "#000000",
            })
    ...
    drawSpecial(vis:MaterialVisualizer, group:ResourceGroup)
    {
        ...
        const positions = [
            actionOffset,
            new Vector2(vis.size.x - actionOffset.x, actionOffset.y)
        ]
