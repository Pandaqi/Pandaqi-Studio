...
export const CONFIG = 
{
    ...
    _resources:
    {    
        base: "/the-luck-legends/roll/lucky-lions/assets/",
        files:
        {
            berylium:
            {
    ...
    _drawing:
    {
        ...
        cards:
        {
            ...
            cycle:
            {
                ...
                peopleIconDims: new CVal(new Vector2(0.2), "sizeUnit"),
                rotateAnimals: false,
            },
            ...
            score:
            {
                ...
                textBoxPos: new CVal(new Vector2(0.795, 0.1375), "size"),
                textColor: "#023d00"
            },

            power:
            {
                textBoxPos: new CVal(new Vector2(0.5, 0.85), "size"),
                textBoxDims: new CVal(new Vector2(0.85), "sizeUnit"),
                textDims: new CVal(new Vector2(0.75, 0.25), "size"), // should be slightly smaller than textBoxDims
            ...
            animal:
            {
                iconPos: new CVal(new Vector2(0.5), "size"),
                iconDims: new CVal(new Vector2(0.5), "sizeUnit")
            }
        },
    },
}