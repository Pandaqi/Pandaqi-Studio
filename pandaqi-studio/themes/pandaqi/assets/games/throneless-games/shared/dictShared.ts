...
export interface PackData
{
    ...
    {
        scale?: number,
        offset?: Vector2 // offset is usually scaled by card size, and relative to card center
        shadowColor?: string,
        shadowBlur?: number,
    },
    ...
    slogan?: 
    {
        ...
        color?: string,
        colorDark?: string,
        offset?: Vector2, // this offset is relative to the bottom of the card
        alpha?: number,
        maxWidth?: number
    },
    ...
    edges?: 
    {
        ...
        colorDark?: string,
        lineWidth?: number,
        lineScale?: Vector2, // how much of the full size it should take up
...
export const PACK_DEFAULT:PackData = 
{
    ...
    name: 
    {
        ...
        offset: new Vector2(0, 0.082),
        shadowOffset: new Vector2(0, 0.015)
    },
    ...
    {
        scale: 1.35/2,
        offset: new Vector2(0, -0.33), // offset is usually scaled by card size, and relative to card center
    ...
    slogan: 
    {
        ...
        color: "#000000",
        colorDark: "#FFFFFF",
        offset: new Vector2(0, -0.055), // this offset is relative to the bottom of the card
        alpha: 1.0,
        maxWidth: 0.68
    },
    ...
    edges: 
    {
        ...
        colorDark: "#FFFFFF",
        lineWidth: 0.0066,
        lineScale: new Vector2(0.75, 0.85), // how much of the full size it should take up
