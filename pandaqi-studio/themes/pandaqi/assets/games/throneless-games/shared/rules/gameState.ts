...
import { fromArray, Vector2, TextConfig, LayoutOperation, DropShadowEffect, convertCanvasToImage } from "lib/pq-games";
...
export default class GameState
{
    ...
    async draw(sim:InteractiveExampleSimulator)
    {
        ...
        const circleCenter = new Vector2(0.5*canvas.width, 0.5*canvas.height);
        ...
        sim.getOutputBuilder().addNode(container);
    }
}