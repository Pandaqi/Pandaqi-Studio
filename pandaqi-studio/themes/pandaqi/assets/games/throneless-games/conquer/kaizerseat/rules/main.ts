...
CONFIG._rulebook.examples["turn-kaizerseat"].callback = callback;
CONFIG._rulebook.examples["turn-kaizerseat"].simulator.enabled = SIMULATION_ENABLED;
CONFIG._rulebook.examples["turn-kaizerseat"].simulator.iterations = SIMULATION_ITERATIONS;
CONFIG._rulebook.examples["turn-kaizerseat"].simulator.showFullGame = SHOW_FULL_GAME;
