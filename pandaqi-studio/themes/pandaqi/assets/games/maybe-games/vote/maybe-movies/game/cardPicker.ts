...
import { getWeighted, shuffle, BalancedFrequencyPickerWithMargin, fromArray, toTextDrawerImageStrings } from "lib/pq-games";
...
{
    if(!CONFIG._settings.sets.blockbusterBudgets.value) { return; }
