import { toTextDrawerImageStrings } from "lib/pq-games"
...
export const PUBLIC_IDENTITIES:Record<string,IdentityCardData> =
{
    ...
    // @IMPROV: hard to guarantee order if multiple players have this, think about this
...
export const MASTER_CARDS:Record<string,MasterCardData> =
{
    ...
    // @IMPROV: invent a few more of these with variations of lowest number and such
