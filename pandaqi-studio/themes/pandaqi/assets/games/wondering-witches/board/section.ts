...
export default class Section 
{
	...
	asRect() : Rectangle
	{
		...
		return new Rectangle().fromTopLeft(
			new Vector2(this.x * size.x, this.y * size.y),
			new Vector2(this.width * size.x, this.height * size.y)
		);
	}
	...
	getCellSize() { return new Vector2(this.cfg.rectWidth, this.cfg.rectHeight); }
