...
export default class CanvasPowerups 
{
    ...
    pencilLengthFactor: number;
    game: any;
    powerupDefaults: { linesOffset: number; pointsOffset: number; distance: boolean; stuck: boolean; fixed: boolean; repel: boolean; add: boolean; };
    ...
    distanceCheckPassed(point: Vector2)
    {
    ...
    intersectCheckPassed(line: Line)
    {
