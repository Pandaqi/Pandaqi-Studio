...
export default class Triangle 
{
    ...
    center()
    {
        ...
        const realCenter = new Vector2(0.5*(b.min.x + b.max.x), 0.5*(b.min.y + b.max.y));
    ...
    {
        const b = this.getBoundingBox();
        const offset = new Vector2(b.width / resolution, b.height / resolution);
        return offset.x;
    }
    ...
    {
        const b = this.getBoundingBox();
        const numPoints = new Vector2(resolution + 1, resolution + 1);
        const offset = new Vector2(b.width / resolution, b.height / resolution);
        const start = b.min;
