...
export const CONFIG =
{
    ...
    tiles: 
    {
        ...
        tileSizeOffset: new Vector2(),

        sizePerShape: {
            rectangle: new Vector2(4, 5),
            hexagon: new Vector2(5, 5),
            triangle: new Vector2(5, 7),
            //triangle: { x: 8, y: 6 },
        },
        sizePerShapeReduced: {
            rectangle: new Vector2(6, 8),
            hexagon: new Vector2(6, 8),
            triangle: new Vector2(10, 8),
        },
        bgColor: "#EBEBEB",
    ...
    cards: 
    {
        ...
        gridPerShape: {
            rectangle: new Vector2(5, 5),
            hexagon: new Vector2(5, 5),
            triangle: new Vector2(10, 5)
        },
        gridPerShapeReduced: {
            rectangle: new Vector2(6, 6),
            hexagon: new Vector2(6, 6),
            triangle: new Vector2(6, 6)
        },
        strokeStyle: "#000000",
        fillStyle: "#EDEDED",
