...
export const CONFIG:Record<string,any> =
{
    ...
    _resources:
    {    
        base: "/easter-eggventures/play/reggverse-riddles/assets/",
        files:
        {
            action_tiles:
            {
    ...
    _drawing:
    {
        tiles:
        {
            ...
            action:
            {
                iconPos: new CVal(new Vector2(0.5, 0.25), "size"),
                iconDims: new CVal(new Vector2(0.4), "size"),
            },
            
            objective:
            {
                fontSize: new CVal(0.07, "sizeUnit"),
                iconPos: new CVal(new Vector2(0.5, 0.275), "size"),
                iconDims: new CVal(new Vector2(0.5), "size"),
                textBoxPos: new CVal(new Vector2(0.5, 0.72), "size")
            },

            movementGrid:
            {
                pos: new CVal(new Vector2(0.5, 0.22), "size"),
                size: new CVal(new Vector2(0.38), "size"),
            ...
            powerText:
            {
                ...
                textBoxPos: new CVal(new Vector2(0.5, 0.78), "size"),
            ...
            map:
            {
                iconDims: new CVal(new Vector2(0.8), "size")
            }
        }
    }
}
