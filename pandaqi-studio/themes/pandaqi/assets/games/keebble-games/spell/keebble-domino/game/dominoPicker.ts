...
import { rangeInteger, getWeighted } from "lib/pq-games";
...
export const dominoPicker = () : Domino[] =>
{
    ...
    for(const symbol of Object.keys(LETTERS))
    {
        ...
        if(expansion && !CONFIG._settings.expansions[expansion].value)
        {
    ...
    if(!CONFIG._settings.expansions.specialCells.value) { numSpecialCells = 0; }
    ...
    if(CONFIG._settings.expansions.specialCells.value) { emptyDominoProb = 0.01; } 
