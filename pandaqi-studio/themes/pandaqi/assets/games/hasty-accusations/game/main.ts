...
export default class Generator
{
    ...
    async loadAssets()
    {
        ...
        const assetsToLoad = {};
        for(const [key,data] of Object.entries(CONFIG._resources.files))
        {
            // @ts-ignore
    ...
    async drawCards(type:string, cards:Card[])
    {
        ...
        const visualizerPlay = new Visualizer(this.resLoader, gridMapper.getMaxElementSize(), vis.inkFriendly);
