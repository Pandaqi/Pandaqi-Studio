import { Bounds, Vector2, fromArray, createContext, convertCanvasToImage, arraysAreDuplicates, anyMatch, shuffle } from "lib/pq-games";
...
class Card
{
    ...
    async draw(small = false)
    {
        ...
        if(small) {
            ...
            const positions = [
                new Vector2(numberOffset, size.y-numberOffset),
                new Vector2(size.x-numberOffset, numberOffset+0.66*fontSize)
            ]
