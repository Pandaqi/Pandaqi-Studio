...
export const sendAction = async (obj: PeerfulComponent, actionName:string, data:any = null, mask:string[] = undefined) =>
{
...
export const receiveAction = (obj: PeerfulComponent, actionName:string, callback:Function) =>
{
    const [send,receive] = obj.room.makeAction(actionName);
    receive(callback);
}
...
export const askQuestion = (obj: PeerfulComponent, actionName: string, data:any = "", callback: Function) =>
{
...
export const answerQuestion = (obj: PeerfulComponent, actionName: string, dataTransformation: Function) => 
{
