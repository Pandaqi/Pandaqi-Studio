...
const ROLVOORDELEN = [
	...
	// TO DO: a few more entries? (Also different types, because being the "trol" is also a sort of "role"?)
];
...
// TO DO: Dat idee van "je moet ofwel de kaartsoorten ofwel de getallen reproduceren, maar je weet nog niet welke" is sterk, moet ik ergens gebruiken (en dan moeten mensen véél kaarten onthouden!)
// TO DO: Nog één opdracht met inspanningskaarten, misschien ietsje minder zwaar deze keer
// TO DO: Iets meer opdrachten met speciale rol voor de PM (en leider, in mindere mate)
// TO DO: Remove "leider kiest wie begint" en dat soort shit van opdrachten, want dat gebeurt nu automatisch

// TO DO: Deze keuze in een opdracht stoppen => Dan maakt de leider een keuze: ofwel de inzet van deze opdracht wordt verdeeld over de persoonlijke geldstapels van de spelers in de groep, ofwel alle spelers in de groep krijgen een joker (maar al het geld gaat verloren).</p>
