...
function createSegments(params)
{
    const segments = [];
...
function getPointsFromSegments(params, segments)
{
...
{
    constructor(params) { this.prepareConstants(params); }
    prepareConstants(params)
    {
        const p0 = params.p0;
        const p1 = params.p1;
        const p2 = params.p2;
...
export default function smoothPath(params)
{
