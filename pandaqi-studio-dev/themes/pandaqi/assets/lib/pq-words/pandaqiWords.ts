import { WordData, WordDataList, WordMetadata } from "./wordData";
...
export interface PandaqiWordsParams
{
    path?: string;
    useAll?: boolean;
    types?: string[];
...
export class PandaqiWords 
{
    ...
    constructListFromKeys(keys:string[], params:PandaqiWordsParams = {})
    {
        this.list = [];
    ...
    constructListFromQueries(queries:Query[], params:PandaqiWordsParams = {})
    {
        this.list = [];
    ...
    async loadWithParams(params:PandaqiWordsParams = {})
    {
    ...
    async loadJsonWithQueries(path:string, queryList:Query[], params:PandaqiWordsParams)
    {
    ...
    async loadTxtWithQueries(path:string, queryList:Query[], params:PandaqiWordsParams)
    {
