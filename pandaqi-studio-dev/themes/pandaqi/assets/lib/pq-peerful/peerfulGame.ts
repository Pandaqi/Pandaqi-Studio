...
export type PeerfulComponent = PeerfulClient | PeerfulServer
export interface PeerfulConfig
{
    debug?: boolean,
    node?: HTMLElement,
    appId: string,
...
export interface PeerfulLoginData
{
    auth: string,
    state: GameState,
    names: string[]
...
export class PeerfulGame
{
    ...
    createHTML()
    {
        ...
        listenForEvent("peer-creation-success", successHandler, this.config);
