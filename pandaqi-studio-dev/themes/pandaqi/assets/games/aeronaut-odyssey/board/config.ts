...
export const CONFIG = 
{
    _settings:
    {
        boardClarity:
        {
            ...
            default: "clean",
            values: ["chaos", "okay", "normal", "clean", "superclean"],
            remark: "More clarity means the board does more checks to prevent ugly situations. That, however, takes much longer to generate."
        },
        ...
        useRealMaterial:
        {
            ...
            default: false,
            remark: "Creates a board playable using a Ticket to Ride game!"
        },
        ...
        expansions:
        {
            ...
            trajectories:
            {
                type: SettingType.CHECK,
                default: false,
                remark: "Get points for completing specific routes."
            },
            ...
            wildWinds:
            {
                type: SettingType.CHECK,
                default: false,
                remark: "Adds wildcard routes and balloons (use/get a type of choice)."
            },
            ...
            multiRoutes:
            {
                type: SettingType.CHECK,
                default: false,
                remark: "Some routes require players to collaborate to complete them."
            },
            ...
            bonusBalloons:
            {
                type: SettingType.CHECK,
                default: false,
                remark: "Some routes have a bonus or penalty for using it."
            }
        }
    },
    ...
    generation:
    {
        ...
        minConnectionsPerVector2: new Bounds(1,2),
        ...
        trajectorySize: new Vector2(1.4, 0.35), // this is relative to "block size"; roughly 4/1 ratio
        calculatedTrajectoryRectOffset: null, // as it says: calculated during generation
        trajectoryVector2sMultiplier: { tiny: 0.75, small: 0.875, regular: 1.0, large: 1.15, huge: 1.3 },
        trajectoryScorePerBlock: 1.25,
        trajectoryScoreRandomization: new Bounds(0.9, 1.1),
        maxScoreForNonVector2sTrajectory: 7,
        ...
        maxRouteAreaVector2s: 20, // at this point, we can give up trying to find an enclosed area, we're probably at the edge
    ...
    evaluator:
    {
        ...
        maxRoutesOfSameTypeAtVector2: new Bounds(5,3),
    ...
    display:
    {
        ...
        playerAreas:
        {
            ...
            edgeOffset: new Vector2(0.02, 0.02),
            sizeRaw: new Vector2(0.25, 0.25), // X is relative (scales to stay consistent), Y is absolute (shrinks as map gets bigger)
        ...
        blocks:
        {
            ...
            bevelLightVec: new Vector2(-1, -1).normalize()
        },
