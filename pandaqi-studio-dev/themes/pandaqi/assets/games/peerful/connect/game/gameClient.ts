import { convertEventToLocal, addTouchEvents, Vector2 } from "lib/pq-games";
import { PeerfulClient, receiveAction, sendAction } from "lib/pq-peerful";
...
export default class GameClient
{
    ...
    move(node:HTMLElement, pos:Vector2)
    {
