...
{
    princess: { frame: 0, label: "Princess" },
    prince: { frame: 1, label: "Prince" },
    troll: { frame: 2, label: "Troll" },
    snowman: { frame: 3, label: "Snowman" },
    dog: { frame: 4, label: "Dog" },
    cat: { frame: 5, label: "Cat" },
    grandfather: { frame: 6, label: "Grandpa" },
    grandmother: { frame: 7, label: "Grandma" },
    elf: { frame: 8, label: "Elf" },
    sorcerer: { frame: 9, label: "Wizard" },
    witch: { frame: 10, label: "Witch" },
    donkey: { frame: 11, label: "Donkey" },
    robot_doll: { frame: 12, label: "Robot" },
    little_baby: { frame: 13, label: "Doll" },
    teddy_bear: { frame: 14, label: "Teddy Bear" },
    bard: { frame: 15, label: "Bard" }
}
