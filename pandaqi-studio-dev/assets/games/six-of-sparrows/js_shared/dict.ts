...
const BID_CARDS:Record<string, GeneralData> =
{
    ...
    one_pair: { frame: 2, score: 100, label: "Match Together", desc: "I'll complete my bid using the cards of <b>another player</b> (instead of the table).", bonusBid: true }, // @TODO: replace icon with new bonus bid

    //one_pair: { frame: 2, score: 20, label: "One Pair", desc: "<b>1 Pair.</b> <i>(Pair means two cards with the same number.)</i>", bonusBid: true }, // @TODO:
    ...
    flush_mid: { frame: 12, score: 100, label: "Medium Group", desc: "5 cards of the <b>same suit</b>." }, // @TODO: update icon
    flush_long: { frame: 13, score: 180, label: "Long Group", desc: "6 cards of the <b>same suit</b>." }, // @TODO: update icon
    ...
    straight_flush_long: { frame: 22, score: 180, label: "Long Band", desc: "5 cards in <b>numerical order</b> <i>and</i> of the <b>same suit</b>." },
    straight_flush_extreme: { frame: 23, score: 200, label: "Superlong Band", desc: "6 cards in <b>numerical order</b> <i>and</i> of the <b>same suit</b>." },
    ...
    flush_hand: { frame: 28, score: 100, label: "Hand Group", desc: "<b>Every suit</b> from the <b>table</b> is present in my <b>hand</b>." }, // @TODO: update icon?
    no_duplicates: { frame: 29, score: 140, label: "No Duplicates", desc: "My hand has <b>no</b> <i>duplicate numbers</i>." }, // @TODO: update icon?
