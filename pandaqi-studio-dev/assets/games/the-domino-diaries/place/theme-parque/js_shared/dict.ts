...
const ATTRACTIONS =
{
    ...
    wooden_coaster: { frame: 3, desc: "If <b>2 Decorations</b> nearby.", value: 4, set: "base" },
    ...
    steel_coaster: { frame: 11, desc: "If <b>3(+) Decorations nearby</b> its queue.", value: 4, set: "unibearsal" },
}

// "Simpler" scoring methods. Don't need a queue or any other setup, often just a raw number of points with nothing else.
const STALLS = 
{
    toilet: { frame: 0, desc: "Worth <b>#Toilets</b> along its nearby path(s).", value: 1, dynamic: true, set: "base" },
    food: { frame: 1, desc: "", value: 2, set: "base" },
    souvenir: { frame: 2, desc: "If <b>no souvenir shop</b> nearby.", value: 3, set: "base" },
    kiosk: { frame: 3, desc: "If <b>3(+) regular paths</b> nearby.", value: 4, set: "base" },

    drinks: { frame: 4, desc: "If <b>nearby a queue</b>.", value: 1, set: "wishneyland" },
    balloons: { frame: 5, desc: "If <b>not nearby</b> a <b>scorable item</b>.", value: 2, set: "wishneyland" },
    photo_booth: { frame: 6, desc: "Worth <b>half</b> the value of a <b>nearby Attraction</b>.", value: 3, dynamic: true, set: "wishneyland" },
    cash_machine: { frame: 7, desc: "Worth <b>#Stalls</b> nearby the <b>same path(s)</b> as me.", value: 4, dynamic: true, set: "wishneyland" },
...
const DECORATIONS =
{
    ...
    dump: { frame: 1, desc: "Adds <b>-2</b> to each <b>nearby scorable item</b>.", value: 2, set: "base" },
    statue: { frame: 2, desc: "If <b>nearby a queue</b>, adds <b>+2</b> to its attraction.", value: 3, set: "base" },
    bulldozer: { frame: 3, desc: "<b>Overlap</b> an existing (unclaimed) tile with this one.", value: 4, set: "base" },

    lantern: { frame: 4, desc: "Every <b>nearby path</b> counts as <b>2 paths</b>.", value: 3, set: "wishneyland" },
    ...
    flowers: { frame: 7, desc: "Adds <b>+2</b> to each <b>nearby scorable item</b>.", value: 1, set: "wishneyland" },

    bin: { frame: 8, desc: "If placed <b>nearby a Pawn</b>, it returns to its owner.", value: 4, set: "unibearsal" },
    bench: { frame: 9, desc: "At turn end, draw <b>2 extra dominoes</b>.", value: 3, set: "unibearsal" },
    office: { frame: 10, desc: "<b>No scorable item</b> can be placed <b>nearby</b> me.", value: 1, set: "unibearsal" },
