...
const ADVANCED_SET:ActionSet = 
{
    ...
    antidote: { frame: 2, type: AType.MURDER, subType: SType.PROTECT, label: "Antidote", desc: "Adds 2 <b>Poison</b> if played openly; removes 2 <b>Poison</b> if played secretly.", protectQuotient: 0.66, murderQuotient: 0.66 }, // @TODO: potential issue with new rules
