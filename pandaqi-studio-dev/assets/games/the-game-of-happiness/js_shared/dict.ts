...
const PERSONAL_CARDS:CategoryDataList = [
    ...
    // PERSONAL
    { desc: "Playing a game against the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Going a night out with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Watching a movie with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Going to the theatre with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Sharing a bedroom with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Going on a long road trip with <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Having a large dinner with <b>all the current players</b>.", pack: Pack.PERSONAL },
    { desc: "Forming a band with <b>all the current players</b>.", pack: Pack.PERSONAL },
    { desc: "Starting a business with <b>all the current players</b>.", pack: Pack.PERSONAL },
    { desc: "Starting a business with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Tutoring the <b>player on your right</b> on a subject or skill.", pack: Pack.PERSONAL },
    { desc: "Sharing a prison cell with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Exercising or sporting together with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Showing your work for critique to the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Discussing money struggles with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Asking the <b>player on your left</b> for advice in relationships.", pack: Pack.PERSONAL },
    { desc: "Asking the <b>player on your right</b> for advice in school or career.", pack: Pack.PERSONAL },
    { desc: "Attending a music festival with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Hiking or taking a long walk with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Visiting some historic or impressive landmark with <b>all the current players</b>.", pack: Pack.PERSONAL },
    { desc: "Being the tour guide for the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Going on a date with the <b>player on your right</b>.", pack: Pack.PERSONAL },
    { desc: "Sharing your smartphone or computer with the <b>player on your left</b>.", pack: Pack.PERSONAL },
    { desc: "Stepping into the shower right after the <b>player on your right</b> used it.", pack: Pack.PERSONAL },
    { desc: "The <b>player on your left</b> becoming the leader of your country.", pack: Pack.PERSONAL },
    { desc: "The <b>player on your right</b> becoming your personal doctor.", pack: Pack.PERSONAL },
    { desc: "Using the <b>player on your left</b> as your model for photography.", pack: Pack.PERSONAL },
    { desc: "Using the <b>player on your right</b> as a role model for younger kids.", pack: Pack.PERSONAL },
    { desc: "Asking the <b>player on your left</b> for permission every time you want to change jobs.", pack: Pack.PERSONAL },
    { desc: "Asking the <b>player on your right</b> for permission every time you want to leave the house.", pack: Pack.PERSONAL },
    { desc: "Reading a book the <b>player on your left</b> wrote.", pack: Pack.PERSONAL },
    { desc: "Using a product the <b>player on your right</b> designed and produced.", pack: Pack.PERSONAL },
];
