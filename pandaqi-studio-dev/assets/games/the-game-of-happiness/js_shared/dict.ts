...
const ITEM_CARDS:CategoryDataList = [
    { desc: "Owning a smartphone." },
    { desc: "Owning a computer." },
    { desc: "Owning a smart watch." },
    { desc: "Owning quality headphones or earbuds." },
    { desc: "Owning designer clothing or accessories." },
    { desc: "Owning a stylish handbag." },
    { desc: "Owning trendy sunglasses." },
    { desc: "Owning a high-end camera." },
    { desc: "Owning outdoor gear for camping or hiking." },
    { desc: "Owning comfortable furniture." },
    { desc: "Owning valuable artwork." },
    { desc: "Owning smart home devices or appliances." },
    { desc: "Owning limited editions of something." },
    { desc: "Owning a large book collection." },
    { desc: "Owning antique items." },
    { desc: "Owning collector's items or memorabilia." },
    { desc: "Owning a stylish suitcase or travel gear." },
    { desc: "Owning workout equipment." },
    { desc: "Owning premium yoga mats." },
    { desc: "Owning a massage chair." },
    { desc: "Owning kitchen gadgets." },
    { desc: "Owning high-quality cookware or knives." },
    { desc: "Owning a gourmet set." },
    { desc: "Having a subscription to a food delivery service." },
    { desc: "Having a subscription to a magazine." },
    { desc: "Having a subscription to a newspaper." },
    { desc: "Owning luxury skincare or beauty products." },
    { desc: "Owning high-end perfumes or colognes." },
    { desc: "Owning a high-definition (TV) screen." },
    { desc: "Owning a gaming console." },
    { desc: "Owning a VR (Virtual Reality) headset." },
    { desc: "Owning an impressive car or motorcycle." },
    { desc: "Owning an electric bike or scooter." },
    { desc: "Owning a home." },
    { desc: "Owning a huge garden." },
    { desc: "Owning a dedicated workshop for your hobbies." },
    { desc: "Owning premium tools for creative pursuits." },
    { desc: "Having a subscription to quality education or workshops." },
    { desc: "Owning a good quality mattress and pillows." },
    { desc: "Owning a bike." },
    { desc: "Having large savings in your bank account." },
    { desc: "Owning a fitness tracker." },
    { desc: "Owning a lot of educational or self-improvement books." },
    { desc: "Having a subscription that allows easy and cheap travel anywhere." },
    { desc: "Owning all musical instruments in the world." },
    { desc: "Owning a vacuum cleaner." },
    { desc: "Owning lots of jewelry." },
    { desc: "Owning many stylish hats." },
    { desc: "Receiving lots of gifts on a daily basis." },
    { desc: "Owning a surround sound system." },
    { desc: "Owning ergonomic furniture." },
    { desc: "Owning all office supplies you'd ever need for work." },
    { desc: "Owning beautiful shoes for all situations." },
    { desc: "Owning a first aid kit." },
    { desc: "Securing your home with a smart alert system." },
    { desc: "Owning exclusively green or eco-friendly items." },
    { desc: "Owning a subscription for cheap public transportation." },

    { desc: "Breaking your smartphone screen.", feeling: Feeling.UNHAPPY },
    { desc: "Being hacked on your personal computer.", feeling: Feeling.UNHAPPY },
    { desc: "Having a slow or malfunctioning computer.", feeling: Feeling.UNHAPPY },
    { desc: "Receiving bills.", feeling: Feeling.UNHAPPY },
    { desc: "Receiving a financial statement that you have a negative balance.", feeling: Feeling.UNHAPPY },
    { desc: "Wearing clothing that's too tight or too loose.", feeling: Feeling.UNHAPPY },
    { desc: "Wearing clothing that's from a different era.", feeling: Feeling.UNHAPPY },
    { desc: "Having holes or stains in your clothing.", feeling: Feeling.UNHAPPY },
    { desc: "Receiving presents that don't align with your personal values.", feeling: Feeling.UNHAPPY },
    { desc: "Having an overcrowded room.", feeling: Feeling.UNHAPPY },
    { desc: "Accidentally spoiling your favorite food.", feeling: Feeling.UNHAPPY },
    { desc: "Having an empty refrigerator.", feeling: Feeling.UNHAPPY },
    { desc: "Not owning a washing machine.", feeling: Feeling.UNHAPPY },
    { desc: "Not owning a stove or microwave.", feeling: Feeling.UNHAPPY },
    { desc: "Not owning heating or airconditioning.", feeling: Feeling.UNHAPPY },
    { desc: "Not owning any gloves or shoes.", feeling: Feeling.UNHAPPY },
    { desc: "Owning furniture that creaks and wobbles.", feeling: Feeling.UNHAPPY },
    { desc: "Owning furniture in wildly different styles.", feeling: Feeling.UNHAPPY },
    { desc: "Having many pieces of artwork in your home that you find ugly.", feeling: Feeling.UNHAPPY },
    { desc: "Receiving an inheritance full of worthless junk.", feeling: Feeling.UNHAPPY },
    { desc: "Having an unpleasant smell in your home you can't get rid of.", feeling: Feeling.UNHAPPY },
    { desc: "Wanting to exercise but not having the (right) fitness equipment.", feeling: Feeling.UNHAPPY },
    { desc: "Not owning a car.", feeling: Feeling.UNHAPPY },
    ...
    { desc: "Bringing your computer to teach support in a rage, where they explain that you forgot to plug it in.", feeling: Feeling.AWKWARD, pack: Pack.SILLY  },
...
const CHANGE_CARDS:CategoryDataList = [
    ...
    { desc: "Past: you can move your date of birth by at most 10 years.", pack: Pack.PAST },
