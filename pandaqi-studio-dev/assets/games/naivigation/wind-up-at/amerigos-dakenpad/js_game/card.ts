...
import { CARD_TEMPLATES, CardType, GiftType, KAARTEN, MISC, ROUTEKAARTEN } from "../js_shared/dict";
...
export default class Card
{
    ...
    drawCornerNumbers(vis:MaterialVisualizer, group:ResourceGroup, invert = false)
    {
        ...
        const resDot = new ResourceShape(new Circle({ center: new Point(), radius: 0.5*dotSize.x }));
