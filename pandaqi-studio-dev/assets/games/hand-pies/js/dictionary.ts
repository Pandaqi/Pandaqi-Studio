...
const INGREDIENTS = {
    ...
    croissant: { frame: 16, colorGroup: "red", power: 2, requiredExpansions: ["machine"], prob: 1.5 },
    cupcake: { frame: 17, colorGroup: "blue", power: 1, requiredExpansions: ["machine"], prob: 1.75, timerRelevant: true },
    brownie: { frame: 18, colorGroup: "red", requiredExpansions: ["machine"], prob: 1.25 },
