...
const REGULAR_CARDS:GeneralDict =
{
    ...
    color_match: { frame: 2, desc: "I am <b>%sign% point</b> for every <b>%color% card</b> scored.", label: "Color Match" },
    ...
    empty_bonus: { frame: 7, desc: "I am <b>%sign% point</b> for every <b>textless card</b> scored.", label: "Empty Reward" },
    score_temporary: { frame: 8, desc: "I am <b>%sign% point</b> while I am your last card scored.", label: "Last Reward", prob: 0.5 },
...
const RULE_CARDS:GeneralDict =
{
    ...
    text_same: { frame: 7, desc: "If your last card scored shows <b>no text</b>, you can't point at a pile with a <b>textless</b> card.", label: "Not Textless" }
}
...
const SHY_CARDS:GeneralDict =
{
    ...
    num_cards_less: { frame: 3, desc: "Only player(s) with <b>less than 5 cards</b> (scored) can pick me.", label: "Hand Min" },
