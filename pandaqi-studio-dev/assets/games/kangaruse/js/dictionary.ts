...
const CELLS = {
    ...
    "crocodile": { frame: 4, desc: "While here, nobody can score from squares in the same row or column.", colorGroup: "blue", prob: 1.25 },
    ...
    "thorny_devil": { frame: 7, desc: "If this is your only valid jump, you're out of the game.", colorGroup: "green", prob: 0.75, maxRel: 0.1 },
