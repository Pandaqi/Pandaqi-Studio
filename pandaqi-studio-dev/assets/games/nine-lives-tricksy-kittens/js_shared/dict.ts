...
const POWERS:PowerSet = 
{
    ...
    no_disregard: { desc: "Cards in the same suit as your bid card are NOT disregarded." },
    ...
    same_suit_disregard: { desc: "Any card that's the same suit as the previous card is disregarded." },
    ...
    disregard_above_5: { desc: "Disregard all cards higher than 5." },
    disregard_below_5: { desc: "Disregard all cards less than 5." },
