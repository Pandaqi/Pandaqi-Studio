...
import CardPicker from "./tilePicker";
...
export default class Generator
{
    ...
    async loadAssets()
    {
        ...
        const dims = CONFIG.tiles.dims[CONFIG.cardSize ?? "regular"];
    ...
    async drawCards(cards:Card[])
    {
        ...
        // @TODO: make the default API for this thing much cleaner? And reusable?
