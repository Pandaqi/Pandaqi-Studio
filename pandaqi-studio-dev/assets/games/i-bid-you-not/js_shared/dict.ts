...
const TYPES:Record<string, TileTypeData> =
{
    ...
    // base game
    //
    headphones: { frame: 0, val: 1, label: "Headgrowns", actions: ["If scored, I make all your items worth <b>+1 dollar</b>.", "If scored, I make all your items worth <b>-1 dollar</b>."], set: "base", tags: [{ pos: new Point(796, 446) }, { pos: new Point(276, 421), flip: true }], color: "green" }, // headphones with flowers growing out
    ...
    laptop: { frame: 3, val: 7, label: "Laptopple", actions: ["Only <b>1 tile of my type</b> may be in the offer.", "I can <b>always be played</b> to the offer (disregard numeric order)."], set: "base", tags: [{ pos: new Point(434, 540) }, { pos: new Point(820, 867) }, { pos: new Point(453, 182), flip: true }], color: "purple" }, // multiple laptops with weird shapes stacked on top of each other, and the stack is askew, falling, toppling over
    ...
    clock: { frame: 19, val: 70, label: "Digital Sock", actions: ["Instantly perform an <b>auction</b>.", "<b>Nobody</b> can declare an auction in the <b>next 3 turns</b>."], set: "doubleDevices", tags: [{ pos: new Point(724, 193) }, { pos: new Point(432, 918), flip: true }], color: "red" }, // a cute pair of socks that have digital clocks woven into their fabric
